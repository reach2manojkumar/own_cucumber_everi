package com.everi.actiondriver;
...
import com.everi.actioninterface.ActionInterface;
...
public class Action extends BaseClass implements ActionInterface {
	...
	public boolean isDisplayed(WebDriver driver, WebElement ele) {
		boolean flag = false;
		flag = isfindElement(driver, ele);
		if (flag) {
			flag = ele.isDisplayed();
			if (flag) {
				Assert.assertTrue("The element is Displayed", flag);
//				
			} else {
				Assert.assertFalse("The element is Displayed", flag);
				
			}
		} else {
			Assert.assertFalse("Not displayed ", flag);
	...
	public boolean isSelected(WebDriver driver, WebElement ele) {
		boolean flag = false;
		flag = isfindElement(driver, ele);// Element present or not.
		if (flag) {
			flag = ele.isSelected();
			if (flag) {
	...
	public boolean type(WebElement ele, String text) {
		boolean flag = false;
		try {
			flag = ele.isDisplayed();// Element Displayed or not
			ele.clear();// clear box
			ele.sendKeys(text);
